                            ...
                            <form action="{{ route('tables.update', $table->id) }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-8 form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter name" value="{{ $table->name }}">
                                      </div>
                                      <div class="col-md-4 form-group">
                                        <label for="exampleInputEmail1">Guest Number</label>
                                        <input type="number" name="guest_number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter guest number" value="{{ $table->guest_number }}">
                                      </div>
                                </div>
